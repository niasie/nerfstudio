...
method_configs["depth-nerfacto-big"] = TrainerConfig(
    ...
    pipeline=VanillaPipelineConfig(
        ...
        model=DepthNerfactoModelConfig(
            ...
            hidden_dim=128,
            hidden_dim_color=128,
            appearance_embed_dim=32, #Technically this should be 128 to match the big version but it leads to a VRAM OOM error
            max_res=4096,
            proposal_weights_anneal_max_num_iters=5000,
            log2_hashmap_size=21,
        ),
...
method_configs["depth-nerfacto-huge"] = TrainerConfig(
    method_name="depth-nerfacto",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=100000,
